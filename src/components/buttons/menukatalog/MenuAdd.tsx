...
import { addDish } from '../../../utils/menuaddfood';
...
const AddDish: React.FC<AddDishProps> = ({ idM }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="p-3">
      <div className="mb-3">
        <label htmlFor="Name" className="form-label">Назва блюда</label>
        <input
          type="text"
          id="Name"
          name="Name"
      ...
      <button type="submit" className="btn btn-primary">Додати блюдо</button>
    </form>
  );
};
